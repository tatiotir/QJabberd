...
public:
    ...
    virtual void saveOfflineMessage(QString from, QString to, QByteArray message, QString stamp) = 0;
    ...
    virtual void deleteOfflineMessage(QString jid, QString key) = 0;
    virtual void deleteAllOfflineMessage(QString jid) = 0;
    virtual QList<QVariant> getOfflinePresenceSubscription(QString jid) = 0;
    virtual void saveOfflinePresenceSubscription(QString from, QString to, QByteArray presence,
                                                 QString presenceType) = 0;
    virtual void deleteOfflinePresenceSubscribe(QString from, QString to) = 0;
    ...
    virtual void setLastLogoutTime(QString jid, QString lastLogoutTime) = 0;
    virtual QString getLastLogoutTime(QString jid) = 0;
    virtual void setLastStatus(QString jid, QString status) = 0;
